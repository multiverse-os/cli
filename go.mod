...
replace (
	github.com/multiverse-os/banner/fonts/big => ./terminal/text/banner/fonts/big
	github.com/multiverse-os/banner/fonts/giant => ./terminal/text/banner/fonts/giant
	...
	github.com/multiverse-os/cli/terminal/text/banner/fonts => ./terminal/text/banner/fonts
)
